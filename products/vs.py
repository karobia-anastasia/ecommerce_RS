...
from .models import Product, Order, Transaction, Cart
from products.recommendation import generate_association_rules, get_recommendations, get_recommendations_based_on_rules,recommend_products, train_collaborative_filtering
...
from .recommendations import train_collaborative_filtering, get_recommendations
...
def product_list(request):
    ...
    with transaction.atomic():
        try:
            ...
            return render(request, 'error.html', {'message': 'An error occurred while fetching the products and recommendations.'})
